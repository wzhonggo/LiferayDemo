...
import com.labimo.portlet.tincan.service.TincanStatementResultLocalService;
...
/**
 * Provides the base implementation for the tincan statement result local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.labimo.portlet.tincan.service.impl.TincanStatementResultLocalServiceImpl}.
 * </p>
 *
 * @author wzgong
 ...
 * @generated
 */
public abstract class TincanStatementResultLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TincanStatementResultLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.labimo.portlet.tincan.service.TincanStatementResultLocalServiceUtil} to access the tincan statement result local service.
	 */
	...
	@Override
	public TincanStatementResult addTincanStatementResult(
		TincanStatementResult tincanStatementResult) throws SystemException {
		tincanStatementResult.setNew(true);

		return tincanStatementResultPersistence.update(tincanStatementResult);
	}
	 ...
	 */
	@Override
	public TincanStatementResult createTincanStatementResult(long id) {
		return tincanStatementResultPersistence.create(id);
	}
	...
	@Override
	public TincanStatementResult deleteTincanStatementResult(long id)
		throws PortalException, SystemException {
		return tincanStatementResultPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TincanStatementResult deleteTincanStatementResult(
		TincanStatementResult tincanStatementResult) throws SystemException {
		return tincanStatementResultPersistence.remove(tincanStatementResult);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TincanStatementResult.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tincanStatementResultPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tincanStatementResultPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TincanStatementResult fetchTincanStatementResult(long id)
		throws SystemException {
		return tincanStatementResultPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TincanStatementResult getTincanStatementResult(long id)
		throws PortalException, SystemException {
		return tincanStatementResultPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tincanStatementResultPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TincanStatementResult> getTincanStatementResults(int start,
		int end) throws SystemException {
		return tincanStatementResultPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTincanStatementResultsCount() throws SystemException {
		return tincanStatementResultPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TincanStatementResult updateTincanStatementResult(
		TincanStatementResult tincanStatementResult) throws SystemException {
		return tincanStatementResultPersistence.update(tincanStatementResult);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.labimo.portlet.tincan.model.TincanStatementResult",
			tincanStatementResultLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tincanStatementResultPersistence.getDataSource();
	...
	private TincanStatementResultLocalServiceClpInvoker _clpInvoker = new TincanStatementResultLocalServiceClpInvoker();
}
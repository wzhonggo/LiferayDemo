...
import com.labimo.portlet.tincan.service.TincanAgentLocalService;
...
/**
 * Provides the base implementation for the tincan agent local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.labimo.portlet.tincan.service.impl.TincanAgentLocalServiceImpl}.
 * </p>
 *
 * @author wzgong
 ...
 * @generated
 */
public abstract class TincanAgentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TincanAgentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.labimo.portlet.tincan.service.TincanAgentLocalServiceUtil} to access the tincan agent local service.
	 */
	...
	@Override
	public TincanAgent addTincanAgent(TincanAgent tincanAgent)
		throws SystemException {
		tincanAgent.setNew(true);

		return tincanAgentPersistence.update(tincanAgent);
	}
	 ...
	 */
	@Override
	public TincanAgent createTincanAgent(long id) {
		return tincanAgentPersistence.create(id);
	}
	...
	@Override
	public TincanAgent deleteTincanAgent(long id)
		throws PortalException, SystemException {
		return tincanAgentPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TincanAgent deleteTincanAgent(TincanAgent tincanAgent)
		throws SystemException {
		return tincanAgentPersistence.remove(tincanAgent);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TincanAgent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tincanAgentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return tincanAgentPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tincanAgentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TincanAgent fetchTincanAgent(long id) throws SystemException {
		return tincanAgentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TincanAgent getTincanAgent(long id)
		throws PortalException, SystemException {
		return tincanAgentPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tincanAgentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TincanAgent> getTincanAgents(int start, int end)
		throws SystemException {
		return tincanAgentPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTincanAgentsCount() throws SystemException {
		return tincanAgentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TincanAgent updateTincanAgent(TincanAgent tincanAgent)
		throws SystemException {
		return tincanAgentPersistence.update(tincanAgent);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.labimo.portlet.tincan.model.TincanAgent",
			tincanAgentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tincanAgentPersistence.getDataSource();
	...
	private TincanAgentLocalServiceClpInvoker _clpInvoker = new TincanAgentLocalServiceClpInvoker();
}
...
import com.labimo.portlet.tincan.service.TincanAgentProfileLocalService;
...
/**
 * Provides the base implementation for the tincan agent profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.labimo.portlet.tincan.service.impl.TincanAgentProfileLocalServiceImpl}.
 * </p>
 *
 * @author wzgong
 ...
 * @generated
 */
public abstract class TincanAgentProfileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TincanAgentProfileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.labimo.portlet.tincan.service.TincanAgentProfileLocalServiceUtil} to access the tincan agent profile local service.
	 */
	...
	@Override
	public TincanAgentProfile addTincanAgentProfile(
		TincanAgentProfile tincanAgentProfile) throws SystemException {
		tincanAgentProfile.setNew(true);

		return tincanAgentProfilePersistence.update(tincanAgentProfile);
	}
	 ...
	 */
	@Override
	public TincanAgentProfile createTincanAgentProfile(long id) {
		return tincanAgentProfilePersistence.create(id);
	}
	...
	@Override
	public TincanAgentProfile deleteTincanAgentProfile(long id)
		throws PortalException, SystemException {
		return tincanAgentProfilePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TincanAgentProfile deleteTincanAgentProfile(
		TincanAgentProfile tincanAgentProfile) throws SystemException {
		return tincanAgentProfilePersistence.remove(tincanAgentProfile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TincanAgentProfile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return tincanAgentProfilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tincanAgentProfilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TincanAgentProfile fetchTincanAgentProfile(long id)
		throws SystemException {
		return tincanAgentProfilePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TincanAgentProfile getTincanAgentProfile(long id)
		throws PortalException, SystemException {
		return tincanAgentProfilePersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tincanAgentProfilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TincanAgentProfile> getTincanAgentProfiles(int start, int end)
		throws SystemException {
		return tincanAgentProfilePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTincanAgentProfilesCount() throws SystemException {
		return tincanAgentProfilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TincanAgentProfile updateTincanAgentProfile(
		TincanAgentProfile tincanAgentProfile) throws SystemException {
		return tincanAgentProfilePersistence.update(tincanAgentProfile);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.labimo.portlet.tincan.model.TincanAgentProfile",
			tincanAgentProfileLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tincanAgentProfilePersistence.getDataSource();
	...
	private TincanAgentProfileLocalServiceClpInvoker _clpInvoker = new TincanAgentProfileLocalServiceClpInvoker();
}
...
import com.labimo.portlet.tincan.service.Oauth2ClientLocalService;
...
/**
 * Provides the base implementation for the oauth2 client local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.labimo.portlet.tincan.service.impl.Oauth2ClientLocalServiceImpl}.
 * </p>
 *
 * @author wzgong
 ...
 * @generated
 */
public abstract class Oauth2ClientLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Oauth2ClientLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.labimo.portlet.tincan.service.Oauth2ClientLocalServiceUtil} to access the oauth2 client local service.
	 */
	...
	public Oauth2Client addOauth2Client(Oauth2Client oauth2Client)
		...
		return oauth2ClientPersistence.update(oauth2Client);
	}
	 ...
	 */
	@Override
	public Oauth2Client createOauth2Client(String id) {
		return oauth2ClientPersistence.create(id);
	}
	...
	@Override
	public Oauth2Client deleteOauth2Client(String id)
		throws PortalException, SystemException {
		return oauth2ClientPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Oauth2Client deleteOauth2Client(Oauth2Client oauth2Client)
		throws SystemException {
		return oauth2ClientPersistence.remove(oauth2Client);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Oauth2Client.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return oauth2ClientPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return oauth2ClientPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Oauth2Client fetchOauth2Client(String id) throws SystemException {
		return oauth2ClientPersistence.fetchByPrimaryKey(id);
	}
	...
	public Oauth2Client getOauth2Client(String id)
		throws PortalException, SystemException {
		return oauth2ClientPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return oauth2ClientPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Oauth2Client> getOauth2Clients(int start, int end)
		throws SystemException {
		return oauth2ClientPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getOauth2ClientsCount() throws SystemException {
		return oauth2ClientPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Oauth2Client updateOauth2Client(Oauth2Client oauth2Client)
		throws SystemException {
		return oauth2ClientPersistence.update(oauth2Client);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.labimo.portlet.tincan.model.Oauth2Client",
			oauth2ClientLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = oauth2ClientPersistence.getDataSource();
	...
	private Oauth2ClientLocalServiceClpInvoker _clpInvoker = new Oauth2ClientLocalServiceClpInvoker();
}
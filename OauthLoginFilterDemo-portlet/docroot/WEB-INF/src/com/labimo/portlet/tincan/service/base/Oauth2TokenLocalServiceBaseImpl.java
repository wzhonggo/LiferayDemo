...
import com.labimo.portlet.tincan.service.Oauth2TokenLocalService;
...
/**
 * Provides the base implementation for the oauth2 token local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.labimo.portlet.tincan.service.impl.Oauth2TokenLocalServiceImpl}.
 * </p>
 *
 * @author wzgong
...
public abstract class Oauth2TokenLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.labimo.portlet.tincan.service.Oauth2TokenLocalServiceUtil} to access the oauth2 token local service.
	 */
	 ...
	 */
	@Override
	public Oauth2Token createOauth2Token(long id) {
		return oauth2TokenPersistence.create(id);
	}
	...
	@Override
	public Oauth2Token deleteOauth2Token(long id)
		throws PortalException, SystemException {
		return oauth2TokenPersistence.remove(id);
	}
	...
	@Override
	public Oauth2Token fetchOauth2Token(long id) throws SystemException {
		return oauth2TokenPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public Oauth2Token getOauth2Token(long id)
		throws PortalException, SystemException {
		return oauth2TokenPersistence.findByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public int getOauth2TokensCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.labimo.portlet.tincan.model.Oauth2Token",
	...
	private Oauth2TokenLocalServiceClpInvoker _clpInvoker = new Oauth2TokenLocalServiceClpInvoker();
}
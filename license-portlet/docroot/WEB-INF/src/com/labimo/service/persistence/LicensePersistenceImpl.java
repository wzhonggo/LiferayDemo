...
import com.labimo.NoSuchLicenseException;

import com.labimo.model.License;
import com.labimo.model.impl.LicenseImpl;
import com.labimo.model.impl.LicenseModelImpl;
...
public class LicensePersistenceImpl extends BasePersistenceImpl<License>
	 ...
	 */
	@Override
	public License create(String licenseUuid) {
		License license = new LicenseImpl();

		license.setNew(true);
		license.setPrimaryKey(licenseUuid);
	 ...
	 */
	@Override
	public License remove(String licenseUuid)
		throws NoSuchLicenseException, SystemException {
		return remove((Serializable)licenseUuid);
	}
	...
	@Override
	public License updateImpl(com.labimo.model.License license)
	...
	protected License toUnwrappedModel(License license) {
		...
		licenseImpl.setLicenseUuid(license.getLicenseUuid());
		licenseImpl.setUserId(license.getUserId());
		licenseImpl.setIssueDate(license.getIssueDate());
		licenseImpl.setValidDate(license.getValidDate());
		licenseImpl.setCreateDate(license.getCreateDate());
		licenseImpl.setModifiedDate(license.getModifiedDate());
		licenseImpl.setProductId(license.getProductId());
		licenseImpl.setValid(license.isValid());
	 ...
	 */
	@Override
	public License findByPrimaryKey(String licenseUuid)
		throws NoSuchLicenseException, SystemException {
		return findByPrimaryKey((Serializable)licenseUuid);
	}
	 ...
	 */
	@Override
	public License fetchByPrimaryKey(String licenseUuid)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)licenseUuid);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.labimo.model.License")));

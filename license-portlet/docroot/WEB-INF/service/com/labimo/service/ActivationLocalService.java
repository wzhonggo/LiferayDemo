...
/**
 * Provides the local service interface for Activation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author wzgong
 * @see ActivationLocalServiceUtil
...
public interface ActivationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActivationLocalServiceUtil} to access the activation local service. Add custom service methods to {@link com.labimo.service.impl.ActivationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
<c:choose>
	...
	<c:otherwise>
		...
		//for redirect to redirect_uri
		boolean doActionAfterLogin = portletName.equals(PortletKeys.FAST_LOGIN) ? true : false;
		...
		<aui:form action="<%= loginURL %>" autocomplete='<%= PropsValues.COMPANY_SECURITY_LOGIN_FORM_AUTOCOMPLETE ? "on" : "off" %>' cssClass="sign-in-form" method="post" name="fm">
			...
			<aui:input name="doActionAfterLogin" type="hidden" value="<%= doActionAfterLogin%>" />

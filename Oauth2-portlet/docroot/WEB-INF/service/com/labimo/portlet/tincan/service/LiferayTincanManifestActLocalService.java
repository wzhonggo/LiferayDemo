...
/**
 * Provides the local service interface for LiferayTincanManifestAct. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author wzgong
 * @see LiferayTincanManifestActLocalServiceUtil
...
public interface LiferayTincanManifestActLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LiferayTincanManifestActLocalServiceUtil} to access the liferay tincan manifest act local service. Add custom service methods to {@link com.labimo.portlet.tincan.service.impl.LiferayTincanManifestActLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

...
/**
 * The persistence utility for the tincan sub statement service. This utility wraps {@link TincanSubStatementPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class TincanSubStatementUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(TincanSubStatement tincanSubStatement) {
		getPersistence().clearCache(tincanSubStatement);
	}
	 ...
	 */
	public static List<TincanSubStatement> findWithDynamicQuery(
	 ...
	 */
	public static TincanSubStatement update(
		TincanSubStatement tincanSubStatement) throws SystemException {
		return getPersistence().update(tincanSubStatement);
	}
	 ...
	 */
	public static TincanSubStatement update(
		TincanSubStatement tincanSubStatement, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(tincanSubStatement, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(tincanSubStatement);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(tincanSubStatements);
	}
	...
	*/
	public static com.labimo.portlet.tincan.model.TincanSubStatement create(
		long id) {
	...
	*/
	public static com.labimo.portlet.tincan.model.TincanSubStatement remove(
		long id)
	...
	public static com.labimo.portlet.tincan.model.TincanSubStatement updateImpl(
		com.labimo.portlet.tincan.model.TincanSubStatement tincanSubStatement)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(tincanSubStatement);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.TincanSubStatement findByPrimaryKey(
		long id)
		throws com.labimo.portlet.tincan.NoSuchTincanSubStatementException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.TincanSubStatement fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.labimo.portlet.tincan.model.TincanSubStatement> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TincanSubStatementPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (TincanSubStatementPersistence)PortletBeanLocatorUtil.locate(com.labimo.portlet.tincan.service.ClpSerializer.getServletContextName(),
					TincanSubStatementPersistence.class.getName());

			ReferenceRegistry.registerReference(TincanSubStatementUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(TincanSubStatementPersistence persistence) {
	}

	private static TincanSubStatementPersistence _persistence;
}
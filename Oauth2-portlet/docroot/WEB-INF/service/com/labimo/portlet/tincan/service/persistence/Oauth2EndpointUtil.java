...
/**
 * The persistence utility for the oauth2 endpoint service. This utility wraps {@link Oauth2EndpointPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class Oauth2EndpointUtil {
	 ...
	 */
	public static void clearCache(Oauth2Endpoint oauth2Endpoint) {
		getPersistence().clearCache(oauth2Endpoint);
	}
	 ...
	 */
	public static List<Oauth2Endpoint> findWithDynamicQuery(
	 ...
	 */
	public static Oauth2Endpoint update(Oauth2Endpoint oauth2Endpoint)
		throws SystemException {
		return getPersistence().update(oauth2Endpoint);
	}
	...
	public static Oauth2Endpoint update(Oauth2Endpoint oauth2Endpoint,
		...
		return getPersistence().update(oauth2Endpoint, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(oauth2Endpoint);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(oauth2Endpoints);
	}
	...
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Endpoint create(long id) {
	...
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Endpoint remove(long id)
		throws com.labimo.portlet.tincan.NoSuchOauth2EndpointException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(id);
	}

	public static com.labimo.portlet.tincan.model.Oauth2Endpoint updateImpl(
		com.labimo.portlet.tincan.model.Oauth2Endpoint oauth2Endpoint)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(oauth2Endpoint);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Endpoint findByPrimaryKey(
		long id)
		throws com.labimo.portlet.tincan.NoSuchOauth2EndpointException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Endpoint fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.labimo.portlet.tincan.model.Oauth2Endpoint> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static Oauth2EndpointPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (Oauth2EndpointPersistence)PortletBeanLocatorUtil.locate(com.labimo.portlet.tincan.service.ClpSerializer.getServletContextName(),
					Oauth2EndpointPersistence.class.getName());

			ReferenceRegistry.registerReference(Oauth2EndpointUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(Oauth2EndpointPersistence persistence) {
	}

	private static Oauth2EndpointPersistence _persistence;
}
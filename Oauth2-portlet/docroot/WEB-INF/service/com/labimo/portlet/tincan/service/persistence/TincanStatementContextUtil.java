...
/**
 * The persistence utility for the tincan statement context service. This utility wraps {@link TincanStatementContextPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TincanStatementContextPersistenceImpl
 * @generated
 */
public class TincanStatementContextUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(TincanStatementContext tincanStatementContext) {
		getPersistence().clearCache(tincanStatementContext);
	}
	 ...
	 */
	public static List<TincanStatementContext> findWithDynamicQuery(
	 ...
	 */
	public static TincanStatementContext update(
		TincanStatementContext tincanStatementContext)
		throws SystemException {
		return getPersistence().update(tincanStatementContext);
	}
	...
	public static TincanStatementContext update(
		...
		return getPersistence().update(tincanStatementContext, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(tincanStatementContext);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.labimo.portlet.tincan.model.TincanStatementContext> tincanStatementContexts) {
		getPersistence().cacheResult(tincanStatementContexts);
	}
	...
	*/
	public static com.labimo.portlet.tincan.model.TincanStatementContext create(
		long id) {
	...
	*/
	public static com.labimo.portlet.tincan.model.TincanStatementContext remove(
		long id)
		throws com.labimo.portlet.tincan.NoSuchTincanStatementContextException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(id);
	}

	public static com.labimo.portlet.tincan.model.TincanStatementContext updateImpl(
		com.labimo.portlet.tincan.model.TincanStatementContext tincanStatementContext)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(tincanStatementContext);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.TincanStatementContext findByPrimaryKey(
		long id)
		throws com.labimo.portlet.tincan.NoSuchTincanStatementContextException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.TincanStatementContext fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.labimo.portlet.tincan.model.TincanStatementContext> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TincanStatementContextPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (TincanStatementContextPersistence)PortletBeanLocatorUtil.locate(com.labimo.portlet.tincan.service.ClpSerializer.getServletContextName(),
					TincanStatementContextPersistence.class.getName());

			ReferenceRegistry.registerReference(TincanStatementContextUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(TincanStatementContextPersistence persistence) {
	}

	private static TincanStatementContextPersistence _persistence;
}
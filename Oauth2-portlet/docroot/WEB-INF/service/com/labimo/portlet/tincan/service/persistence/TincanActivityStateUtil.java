...
/**
 * The persistence utility for the tincan activity state service. This utility wraps {@link TincanActivityStatePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class TincanActivityStateUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(TincanActivityState tincanActivityState) {
		getPersistence().clearCache(tincanActivityState);
	}
	 ...
	 */
	public static List<TincanActivityState> findWithDynamicQuery(
	 ...
	 */
	public static TincanActivityState update(
		TincanActivityState tincanActivityState) throws SystemException {
		return getPersistence().update(tincanActivityState);
	}
	 ...
	 */
	public static TincanActivityState update(
		TincanActivityState tincanActivityState, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(tincanActivityState, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(tincanActivityState);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(tincanActivityStates);
	}
	...
	*/
	public static com.labimo.portlet.tincan.model.TincanActivityState create(
		long id) {
	...
	*/
	public static com.labimo.portlet.tincan.model.TincanActivityState remove(
		long id)
	...
	public static com.labimo.portlet.tincan.model.TincanActivityState updateImpl(
		com.labimo.portlet.tincan.model.TincanActivityState tincanActivityState)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(tincanActivityState);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.TincanActivityState findByPrimaryKey(
		long id)
		throws com.labimo.portlet.tincan.NoSuchTincanActivityStateException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.TincanActivityState fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.labimo.portlet.tincan.model.TincanActivityState> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static TincanActivityStatePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (TincanActivityStatePersistence)PortletBeanLocatorUtil.locate(com.labimo.portlet.tincan.service.ClpSerializer.getServletContextName(),
					TincanActivityStatePersistence.class.getName());

			ReferenceRegistry.registerReference(TincanActivityStateUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(TincanActivityStatePersistence persistence) {
	}

	private static TincanActivityStatePersistence _persistence;
}
...
/**
 * The persistence utility for the oauth2 client service. This utility wraps {@link Oauth2ClientPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class Oauth2ClientUtil {
	 ...
	 */
	public static void clearCache(Oauth2Client oauth2Client) {
		getPersistence().clearCache(oauth2Client);
	}
	 ...
	 */
	public static List<Oauth2Client> findWithDynamicQuery(
	 ...
	 */
	public static Oauth2Client update(Oauth2Client oauth2Client)
		throws SystemException {
		return getPersistence().update(oauth2Client);
	}
	...
	public static Oauth2Client update(Oauth2Client oauth2Client,
		...
		return getPersistence().update(oauth2Client, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(oauth2Client);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(oauth2Clients);
	}
	...
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Client create(
		java.lang.String id) {
	...
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Client remove(
		java.lang.String id)
	...
	public static com.labimo.portlet.tincan.model.Oauth2Client updateImpl(
		com.labimo.portlet.tincan.model.Oauth2Client oauth2Client)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(oauth2Client);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Client findByPrimaryKey(
		java.lang.String id)
		throws com.labimo.portlet.tincan.NoSuchOauth2ClientException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.labimo.portlet.tincan.model.Oauth2Client fetchByPrimaryKey(
		java.lang.String id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.labimo.portlet.tincan.model.Oauth2Client> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static Oauth2ClientPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (Oauth2ClientPersistence)PortletBeanLocatorUtil.locate(com.labimo.portlet.tincan.service.ClpSerializer.getServletContextName(),
					Oauth2ClientPersistence.class.getName());

			ReferenceRegistry.registerReference(Oauth2ClientUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(Oauth2ClientPersistence persistence) {
	}

	private static Oauth2ClientPersistence _persistence;
}
...
/**
 * Provides the local service interface for TincanSubStatement. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author wzgong
 * @see TincanSubStatementLocalServiceUtil
...
public interface TincanSubStatementLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TincanSubStatementLocalServiceUtil} to access the tincan sub statement local service. Add custom service methods to {@link com.labimo.portlet.tincan.service.impl.TincanSubStatementLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

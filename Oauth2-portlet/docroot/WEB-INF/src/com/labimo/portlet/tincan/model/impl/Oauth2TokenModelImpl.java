...
public class Oauth2TokenModelImpl extends BaseModelImpl<Oauth2Token>
	...
	public static final String TABLE_SQL_CREATE = "create table labimo_Oauth2Token (id_ LONG not null primary key,code_ VARCHAR(75) null,token VARCHAR(75) null,refreshToken VARCHAR(75) null,clientId LONG,expiredIn LONG,liferayUserId LONG)";

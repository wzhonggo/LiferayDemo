...
public class LicensePersistenceImpl extends BasePersistenceImpl<License>
	 ...
	 */
	@Override
	public License create(LicensePK licensePK) {
		License license = new LicenseImpl();

		license.setNew(true);
		license.setPrimaryKey(licensePK);
	 ...
	 */
	@Override
	public License remove(LicensePK licensePK)
		throws NoSuchLicenseException, SystemException {
		return remove((Serializable)licensePK);
	}
	...
	protected License toUnwrappedModel(License license) {
		...
		licenseImpl.setHardwareUuid(license.getHardwareUuid());
		licenseImpl.setUserId(license.getUserId());
		licenseImpl.setContent(license.getContent());
	 ...
	 */
	@Override
	public License findByPrimaryKey(LicensePK licensePK)
		throws NoSuchLicenseException, SystemException {
		return findByPrimaryKey((Serializable)licensePK);
	}
	 ...
	 */
	@Override
	public License fetchByPrimaryKey(LicensePK licensePK)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)licensePK);
	}
